...
public:// functions
  ...
  float DotProduct(const enVector2& OtherVector);
  //! multiplying two 2D vectors give a scalar.
  float DotProduct(const enVector2& OtherVector) const;
  //! return the theoretical component Z axis 
  float CrossProduct(enVector2& OtherVector);
...
public:
  ...
  bool operator==(const enVector2& OtherVector);
...
static std::ostream& operator<<(std::ostream& Stream, const enVector2& other)
{
